...
var SaveToOrder = function SaveToOrder(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var prevOrder, arrayNumber;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 3:
            prevOrder = _context.sent;
            if (!(prevOrder && prevOrder.orderNumber !== null)) {
              _context.next = 11;
              break;
            }
            arrayNumber = prevOrder.orderNumber;
          ...
          case 11:
            _context.next = 13;
            return _index["default"].Users.findOrCreate({
              where: {
                email: data.email,
                fullName: data.fullName,
                phoneNumber: data.phoneNumber,
          ...
          case 13:
            _context.next = 15;
            return _index["default"].Orders.findOrCreate({
              where: {
                orderNumber: data.orderNumber
              },
              defaults: {
          ...
          case 15:
            _context.next = 17;
            return _index["default"].DetailOrders.bulkCreate(data.description);
          case 17:
            resolve({
              errCode: 0,
              message: "OK"
