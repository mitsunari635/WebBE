...
var checkPolicyName = function checkPolicyName(PolicyName) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _index["default"].Policies.findOne({
              where: {
                name: PolicyName
              }
            });
...
var getAllPolicy = function getAllPolicy(policyId) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 5;
            return _index["default"].Policies.findAll({});
          case 5:
...
var createNewPolicy = function createNewPolicy(data) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return checkPolicyName(data.name);
          case 3:
            ...
            resolve({
              errCode: 1,
              errMessage: "Your Policy name is already in use. Please try another name"
            });
            _context3.next = 10;
            break;
          case 8:
            _context3.next = 10;
            return _index["default"].Policies.create({
              name: data.name,
              type: data.type
            });
          case 10:
...
var deletePolicy = function deletePolicy(policyId) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            _context4.next = 6;
            return _index["default"].Policies.destroy({
              where: {
                id: policyId
              }
            });
...
var updatePolicy = function updatePolicy(data) {
  return new Promise( /*#__PURE__*/function () {
...
var getAllDetailsPolicy = function getAllDetailsPolicy(limitInput) {
  return new Promise( /*#__PURE__*/function () {
...
var saveDetailInforPolicy = function saveDetailInforPolicy(inputData) {
  return new Promise( /*#__PURE__*/function () {
...
var getDetailPolicyById = function getDetailPolicyById(inputId) {
  return new Promise( /*#__PURE__*/function () {
